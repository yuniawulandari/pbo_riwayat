 ...
 * @author ARY DWIS
 */
public class koki2 extends javax.swing.JFrame {

    /**
     * Creates new form koki2
     */
    public koki2() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(koki2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
